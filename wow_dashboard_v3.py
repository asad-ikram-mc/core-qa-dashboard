...
# ── Config ──
# Local: uses AWS_PROFILE env var (e.g. 'your-profile') for ~/.aws/credentials
# GitHub Actions: uses AWS_ACCESS_KEY_ID + AWS_SECRET_ACCESS_KEY + AWS_DEFAULT_REGION env vars
AWS_PROFILE = os.environ.get('AWS_PROFILE')  # None in CI, profile name locally
S3_BUCKET = os.environ.get('S3_BUCKET', 'wikitablescrapexample')
BACKUP_PREFIX = 'check/'
...
def get_boto3_session():
    """Create boto3 session — uses profile locally, env vars in CI."""
    if AWS_PROFILE:
        return boto3.Session(profile_name=AWS_PROFILE)
    else:
        # In CI: reads AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, AWS_DEFAULT_REGION from env
...
if __name__ == '__main__':
    ...
    if missing:
        ...
        print()
        print("  For local development, create a .env file or export:")
        ...
        print("    export DB_PASSWORD=your-pass")
        print()
